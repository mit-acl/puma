...
if __name__ == "__main__":
    ...
    num_linear_layers_list = [2, 4, 8]
    linear_hidden_channels_list = [64, 128, 256, 512]
    ...
    parameters_dict = {
        ...
        'hidden_channels': {
            'values': hidden_channels_list
        },
        'num_heads': {
            'values': num_heads_list
        },
        'num_layers': {
            'values': num_layers_list
        },
        'group': {
            'values': group_list
        },
        'num_linear_layers': {
            'values': num_linear_layers_list
        },
        'linear_hidden_channels': {
            'values': linear_hidden_channels_list
        },
        'batch_size': {
            'values': batch_size
        },
    ...
    # sweep_id
    sweep_id = wandb.sweep(sweep_config, project="puma")
