...
class FastSAM_ROS:
    ...
    def __init__(self):
        ...
        if self.is_sim:
            ...
            self.world_name_topic = "corrupted_world" # if you use perfect_tracker in puma, "world" won't be published.
        else:
        ...
        range_std_dev = 0.5 # 100 cm std dev along range axis
        non_range_std_dev = 0.5 # 50 cm std dev along other axes (non-range)
    ...
    def get_undistortion_params(self):
        ...
        print(f"{self.camera_name_topic}/camera_info")
