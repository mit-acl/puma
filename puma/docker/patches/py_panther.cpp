...
PYBIND11_MODULE(py_panther, m)
{
  ...
  py::class_<mt::parameters>(m, "parameters")
      ...
      // clang-format off
        .def_readwrite("is_frame_alignment", &mt::parameters::is_frame_alignment)
      ...
      .def_readwrite("initial_position_variance_search_multiplier", &mt::parameters::initial_position_variance_search_multiplier)
      .def_readwrite("initial_velocity_variance_search_multiplier", &mt::parameters::initial_velocity_variance_search_multiplier)
      .def_readwrite("initial_acceleration_variance_search_multiplier", &mt::parameters::initial_acceleration_variance_search_multiplier)
      ...
      .def_readwrite("obstacle_consideration_radius", &mt::parameters::obstacle_consideration_radius)                              
