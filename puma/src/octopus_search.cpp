...
void OctopusSearch::setMaxValuesAndSamples(const Eigen::Vector3d& v_max, const Eigen::Vector3d& a_max,
                                           int num_samples_x, int num_samples_y, int num_samples_z,
                                           double fraction_voxel_size)
{
...
// axis=0 (x), 1(y) or 2(z)
// bool OctopusSearch::computeAxisForNextInterval(const int i, const Eigen::Vector3d& viM1, int axis, double&
// constraint_L,
//                                                double& constraint_U)
// {
